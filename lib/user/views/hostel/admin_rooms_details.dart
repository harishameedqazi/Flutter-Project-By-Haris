...
class AdminRoomsDetailsScreen extends StatelessWidget {
  const AdminRoomsDetailsScreen({Key? key, required this.data, this.hostelData})
      : super(key: key);
  final dynamic data;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              onPressed: () {
                controller.deleteHostelRoom(data['hostelId'], data['roomNo']);
              },
              icon: Icon(
                Icons.delete,
